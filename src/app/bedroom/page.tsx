...
//             <h2 className="text-5xl text-white animate-fade-in bg-[#27423a] rounded-lg p-5 font-bold text-center mb-6">Bedroom Furniture</h2>
...
const BedroomPage = () => {
    ...
    return (
        <div className="p-4 md:p-8 flex flex-col items-center">
            ...
            {/* Navigation Buttons */}
            <div className="flex justify-center gap-4 mb-6">
                <Link className="border-2 border-[#27423a] text-[#27423a] text-lg hover:bg-[#27423a] hover:text-white px-4 py-2 rounded" href="/dining">Dining Furniture</Link>
                <Link className="border-2 border-[#27423a] text-[#27423a] text-lg hover:bg-[#27423a] hover:text-white px-4 py-2 rounded" href="/living">Living Room Furniture</Link>
            </div>
